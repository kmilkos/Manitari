...
1. MobileApplication.vb - this class derives from the new MobileApplication class similarly to WinApplication or WebApplication in appropriate platforms. An instance of this class is created for each request from the client application.
