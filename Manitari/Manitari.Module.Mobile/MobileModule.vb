...
<ToolboxItemFilter("Xaf.Platform.Mobile")> _
Partial Public NotInheritable Class ManitariMobileModule
    Inherits ModuleBase
	...
	'	e.Store = New ModelDifferenceDbStore(CType(sender, XafApplication), GetType(ModelDifference), True, "Mobile")
	' 	e.Handled = True
	'End Sub
	Private Sub Application_CreateCustomUserModelDifferenceStore(ByVal sender As Object, ByVal e As CreateCustomModelDifferenceStoreEventArgs)
		e.Store = New ModelDifferenceDbStore(CType(sender, XafApplication), GetType(ModelDifference), False, "Mobile")
		e.Handled = True
	End Sub
    Public Sub New()
        InitializeComponent()
